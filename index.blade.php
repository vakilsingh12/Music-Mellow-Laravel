...
<a href="#" class="navbar-brand text-dark font-weight-bold a1"><span style="color:red;font-size: 25px;">MUSIC</span>Mellow</a>
			...
			<ul class="navbar-nav ml-auto">
				<li class="navbar-item "><a href="index" class="nav-link text-dark ac active">Home</a></li>
				<li class="navbar-item"><a href="audio" class="nav-link text-dark ac">Audio</a></li>
				<li class="navbar-item"><a href="ourteam" class="nav-link text-dark ac">OurTeam</a></li>
				<li class="navbar-item"><a href="contact" class="nav-link text-dark ac">AboutUs</a></li>
				<li class="navbar-item"><a href="#c1" class="nav-link text-dark ac">Contact</a></li>
				<li class="navbar-item"><a href="signup" class="nav-link text-dark ac">Login/Register</a></li>
			</ul>	
			</div>
		</div>
	</nav>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-6 col-sm-6 col-md-6">
					...
					<a href="signin"><button class="b1 pl-4 pr-4 pb-2 pt-2 rounded-pill">SIGN IN</button></a>
					<a href="signup"><button class="b2 pl-4 pr-4 pb-2 pt-2 rounded-pill">START FREE TRIAL</button></a>
				</div>
...
<div class="container">
	<div class="row">
		...
		<div class="col-sm-6 col-lg-6">
			...
			<a href="signup"><button class="mx-5  px-4 py-3 rounded-pill font-weight-bold" style="font-size: 20px;font-family: verdana;background:red;">TRY IT NOW</button></a>
				<br><br>
		</div>
	</div>
</div>
...
<div class="container">
	<div class="row">
		<div class="col-lg-6">
			...
			<p style="font-style: italic;">Consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
			<a href="signin"><button class="font-weight-bold px-4 py-2 my-4 rounded-pill m-2" style="background-color: red;">START NOW</button></a>
		</div>
...
<div class="row">
	<div class="col-sm-4 col-md-4 col-lg-5"><br><br>
		...
		<p>This is the best music player website jbdbs jdsbd jsdb sbjdb sbsd zjbc sdsjbs dskdb dsdiubs dsdfsdbfhs dsdnsbd sdmsdnbs fdnsbhd sds hdfbu fsdfhs</p><br>
		<!-- <ul class="ul1"> -->
